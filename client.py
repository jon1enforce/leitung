    ...
    def _process_phonebook_update(self, data):
        ...
        try:
            ...
            try:
                ...
                print(f"[CLIENT] Received phonebook with {len(phonebook_data)} entries")
                
                # 6. Update GUI im Hauptthread
